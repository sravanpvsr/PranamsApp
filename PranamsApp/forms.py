...
class add_maid_new_form(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
    ...
    #Room=forms.ModelMultipleChoiceField(queryset=Room_Master.objects.all())
  
    def clean(self):
        super(add_maid_new_form, self).clean()        
        # return any errors if found
        return self.cleaned_data

class maid_transaction_form(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

    class Meta:
        model=MaidTransaction
        fields='__all__'
        exclude=["Updated_Date","Updated_By","Status"]
        
    def clean(self):
        super(maid_transaction_form, self).clean()        
        # return any errors if found
        return self.cleaned_data

class maid_renewal_form(forms.ModelForm):
    ...
    def clean(self):
        super(maid_renewal_form, self).clean()        
        # return any errors if found
        return self.cleaned_data

class vehicle_renewal_form(forms.ModelForm):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

    class Meta:
        model=vehicle_renewal
        fields=['Sticker_Num']
        
        
    def clean(self):
        super(vehicle_renewal_form, self).clean()        
        # return any errors if found
        return self.cleaned_data

# class search_Room_transaction_form(forms.ModelForm):

#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)

#     class Meta:
#         model=search_Room_transaction
#         fields='__all__'
               
        
#     def clean(self):
#         super(search_Room_transaction_form, self).clean()        
#         # return any errors if found
#         return self.cleaned_data
class temp_vehicle_form(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
    ...
    def clean(self):
        super(temp_vehicle_form, self).clean()        
        # return any errors if found
        return self.cleaned_data

class temp_vehicle_transaction_form(forms.ModelForm):
    ...
    class Meta:
        model=TempVehicleTransaction
        fields='__all__'
        exclude=["Updated_Date","Updated_By","Status"]
        
    def clean(self):
        super(temp_vehicle_transaction_form, self).clean()        
        # return any errors if found
        return self.cleaned_data